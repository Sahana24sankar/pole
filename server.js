...
// Start server
app.listen(PORT, () => {
  console.log(`🚀 SmartPole Backend Server running on port ${PORT}`);
  console.log(`📡 Health check: http://localhost:${PORT}/api/health`);
  console.log(`📤 Upload endpoint: http://localhost:${PORT}/api/upload-ad`);
  console.log(`📊 Database status: http://localhost:${PORT}/api/test-connection`);
});
